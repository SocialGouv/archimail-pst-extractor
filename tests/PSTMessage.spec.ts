...
describe("PSTMessage tests", () => {
    it("should have email messages", () => {
        ...
        expect(msg.sentRepresentingEmailAddress).toEqual(
        ...
        expect(msg.modificationTime).toEqual(
            new Date("2009-05-11T19:17:12.061Z")
        );
        ...
        expect(msg.clientSubmitTime).toEqual(
        ...
        if (msg.senderEntryId) {
            ...
            expect(msg.senderEntryId.toString()).toContain(
                "JReames@br-inc.com"
            );
        }
    });
